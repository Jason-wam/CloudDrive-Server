...
object MediaType {
    private val mimeTypeVideo = listOf(
        ".mkv", ".asf", ".avi", ".wm", ".wmp", ".wmv", ".ram", ".rm", ".rmvb", ".mov",
        ".f4v", ".flv", ".m2t", ".m2ts", ".mpeg", ".mpg", ".ts", ".m4v", ".mp4", ".3g2", ".3gp", ".vob", ".divx",
        ".mts", ".webm"
    )
    private val mimeTypeAudio = listOf(
        ".aac", ".ac3", ".amr", ".m4a", ".mid", ".midi", ".mp3", ".ogg", ".wav", ".wma",
        ".wv", ".flac", ".ape"
    )
    private val mimeTypeImage = listOf(
        ".png", ".jpg", ".jpeg", ".gif", ".tiff", ".psd", ".webp", ".bmp", ".tif",
        ".eps", ".cdr", ".jfif", ".iff", ".tga", ".pcd", ".mpt", ".raw"
    )
    private val mimeTypeCompress = listOf(
        ".rar", ".zip", ".7z", ".gz", ".apz", ".ar", ".bz", ".car", ".cbz", ".cbr",
        ".dar", ".cpgz", ".jar", ".000", ".001", ".ace", ".tar", ".tgz", ".txz"
    )
    private val mimeTypeAPK = listOf(".apk", ".xapk")
    private val mimeTypeWord =
        listOf(".docx", ".dotx", ".dox", ".wps", ".dot", ".wpt", ".docm", ".dotm", ".doc", ".rtf")
